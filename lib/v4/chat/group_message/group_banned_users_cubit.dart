...
class GroupBannedUsersCubit extends Cubit<GroupBannedUsersState> {
  ...
  GroupBannedUsersCubit({required this.channel, this.toastBloc})
      : super(const GroupBannedUsersState()) {
    loadBannedUsers();
