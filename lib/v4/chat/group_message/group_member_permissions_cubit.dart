...
class GroupMemberPermissionsCubit extends Cubit<GroupMemberPermissionsState> {
  final AmityChannel channel;
  
  GroupMemberPermissionsCubit(this.channel) : super(const GroupMemberPermissionsState()) {
