  ...
  Widget build(BuildContext context) {
    if (type is CommunityFeedStoryTab) {
      ...
      return BlocProvider(
        ...
        child: AmityStoryCommunityTabComponent(createStory: createStory, communityId: communityFeedStoryTab.communityId),
      );
    }
    ...
    if (type is GlobalFeedStoryTab) {
      return BlocProvider(
        ...
        child: AmityStoryGlobalTabComponent( createStory: createStory,),
      );
    }
