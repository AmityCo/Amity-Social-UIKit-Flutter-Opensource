...
class AmityGroupSettingCubit extends Cubit<AmityGroupSettingState> {
  AmityGroupSettingCubit({required AmityChannel channel, required bool isModerator}) 
      : super(AmityGroupSettingState(
          channel: channel, 
          isLoading: true,
