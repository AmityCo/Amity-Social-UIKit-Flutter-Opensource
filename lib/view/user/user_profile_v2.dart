                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Wrap(
                            ...
                            children: [
                              Semantics(
                                identifier: 'amityUserProfileBio',
                                child: Text(
                        ...
                        AmityCoreClient.getCurrentUser().userId ==
                            ...
                            : (vm.amityMyFollowInfo.status ==
                                ...
                                ? Provider.of<AmityUIConfiguration>(
                                    ...
                                    .widgetBuilders
                                    .buildMessageButton(widget.amityUser)
                                : Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Expanded(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    decoration: BoxDecoration(
                                                                        ...
                                                                        borderRadius:
                                                                            BorderRadius.circular(
                                                                                4),
                                                                        color: getFollowingStatusColor(snapshot
                                                                            .data!
                                                                            .status)),
                                                                    padding:
                                                                        const EdgeInsets
                                                                        ...
                                                                        Text(
                                                                          ...
                                                                          style: theme
                                                                            ...
                                                                            fontWeight:
                                                                                FontWeight.w700,
                                                                            color:
                                                                                getFollowingStatusTextColor(snapshot.data!.status),
                                                                            fontSize:
                                                                                15,
                                                                          ),
                                                                        ),
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                            top: widget.customActions == null ? 24 : 6,
                          ),
          ...
          actions: [
            Provider.of<UserFeedVM>(context).amityMyFollowInfo.id == null
                ...
                : StreamBuilder<AmityUserFollowInfo>(
                    ...
                    builder: (context, snapshot) {
                      return Semantics(
                        identifier: 'amityUserProfileMore',
                        child: IconButton(
