...
void main() {
  final AmityUikitBetaServicePlatform initialPlatform =
      AmityUikitBetaServicePlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockAmityUikitBetaServicePlatform fakePlatform =
        MockAmityUikitBetaServicePlatform();
