...
// Page
class NotificationPreferencePage extends NewBasePage {
  ...
  NotificationPreferencePage({
    ...
    this.channel,
    this.user,
  })  : assert(channel != null || user != null,
            "Either channel or user must be provided"),
        super(key: key, pageId: 'notification_preference_page');
  ...
  Widget buildPage(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
            create: (context) =>
                NotificationPreferenceCubit(channel: channel, user: user)),
            ...
            children: [
              Scaffold(
                ...
                body: Column(
                  ...
                  children: [
                    if (channel != null &&
                        channel!.notificationMode == NotificationMode.silent)
                      Container(
                    ...
                    Padding(
                      ...
                      child: _buildNotificationOption(
                        ...
                        description:
                            'Turn on to receive push notifications from this ${channel != null ? "group" : "user"}.',
                        value: state.enabled,
                        onChanged: channel != null &&
                                channel!.notificationMode ==
                                    NotificationMode.silent
                            ? (_) {}
                            : cubit.setEnabled,
                        isSilent: channel != null &&
                            channel!.notificationMode ==
                                NotificationMode.silent,
                      ),
                    ),
